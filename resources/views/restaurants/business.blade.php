...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
		...
		@foreach($business as $accommodations)
		<div class="slider-item" style="background-image: url(/storage/{{ $accommodations->profile_photo}});">
		  ...
		  <div class="container">
			...
			<span class="price">${{ $accommodations->average_price }} /month</span>
			  <a href="{{ route('restaurants.business', $accommodations->id) }}" class="btn-custom p-3 px-4 bg-primary">View Details <span class="icon-plus ml-1"></span></a>
			</div>
		  </div>
		  </div>
		</div>
    ...
    <section class="ftco-section bg-light">
    	...
    	<div class="container-fluid">
    		<div class="row">
				...
				@foreach ($business as $accommodation)
