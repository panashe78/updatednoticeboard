...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
		...
		@foreach($rest as $accommodations)
		<div class="slider-item" style="background-image: url(/storage/{{ $accommodations->profile_photo}});">
		  ...
		  <div class="container">
			...
			<span class="price">${{ $accommodations->average_price }} /month</span>
			  <a href="{{ route('restaurants.restaurant', $accommodations->id) }}" class="btn-custom p-3 px-4 bg-primary">View Details <span class="icon-plus ml-1"></span></a>
			</div>
		  </div>
		  </div>
		</div>
    	...
    	<div class="container">
	    	<div class="row">
					<div class="col-md-12 search-wrap">
						<h2 class="heading h5 d-flex align-items-center pr-4"><span class="ion-ios-search mr-3"></span> Search Restaurant</h2>
    		...
    		<div class="row">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="properties">
    					...
    					<div class="text p-3">
    						<span class="status rent">{{ $accommodation->address }}</span>
    						<div class="d-flex">
    							<div class="one">
	    						...
	    						<div class="two">
	    							<span class="price">${{ $accommodation->average_price }}<small>/ meal</small></span>
    							</div>
    						</div>
