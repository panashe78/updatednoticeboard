  ...
  <div class="container">
    ...
    <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
      <div class="tab-pane fade active show" id="menu-starters">
        ...
        <div class="row gy-5">
          @foreach ($appertizer as $item)
          <div class="col-lg-4 menu-item">
            <a href="{{ asset($item->image) }}" class="glightbox">
              <img src="{{ asset($item->image) }}" class="menu-img img-fluid" alt="{{ $item->name }}">
            </a>
            <h4>{{ $item->name }}</h4>
          ...
          <div class="testimonial-item">
            <div class="row gy-4 justify-content-center">
              ...
              <div class="col-lg-2 text-center">
                <img src="{{ asset($item->user->photo) }}" class="img-fluid testimonial-img" alt="{{ $item->user->name }}">
              </div>
            </div>
          </div>
  ...
  <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
    <div class="swiper init-swiper">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url({{ asset($item->image) }})">
          <h3>{{ $item->title }}</h3>
          <div class="price align-self-start">${{ $item->price }}</div>
      ...
      <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
        <div class="team-member">
          <div class="member-img">
            <img src="{{ asset($item->user->photo) }}" class="img-fluid" alt="{{ $item->user->name }}">
            <div class="social">
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="swiper init-swiper">
      ...
      <div class="swiper-wrapper align-items-center">
        ...
        <div class="swiper-slide">
          <a class="glightbox" data-gallery="images-gallery" href="{{ asset($image->path) }}">
            <img src="{{ asset($image->path) }}" class="img-fluid" alt="Gallery Image">
          </a>
        </div>
        @endforeach
      </div>
