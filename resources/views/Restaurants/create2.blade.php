...
<body style="background-color: white">
    ...
    <h1 style="color: blue">Create Business</h1>
    ...
    <form action="{{ route('restaurants.store') }}" method="POST" enctype="multipart/form-data" class="container mt-4">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                ...
                <!-- Name -->
                <div class="mb-3">
                    <label for="name" class="form-label"></i>Name of Business</label>
                ...
                <div class="mb-3" hidden>
                    ...
                    <input type="text" value="none" name="category" class="form-control form-control-lg" placeholder="Category" required>
                </div>
